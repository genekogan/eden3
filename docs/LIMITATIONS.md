...
- Subscription-backed execution is implemented only for Claude Code. Codex CLI can use a ChatGPT subscription independently, but Eden3 does not yet expose Codex as a chat runtime.
